      ...
      <nav className="fixed top-0 w-full z-50 bg-slate-950/80 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3 group cursor-pointer" onClick={() => navigate("/")}>
            ...
            <span className="text-xl font-bold tracking-tighter text-white">Sentí Empresas</span>
          </div>
      ...
      <footer className="py-12 px-6 border-t border-white/5 bg-slate-950">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-white">Sentí Empresas — Saúde Mental Corporativa</span>
          </div>
          <p className="text-slate-600 text-xs">© 2026 Sentí. Todos os direitos reservados.</p>
        </div>
      </footer>
