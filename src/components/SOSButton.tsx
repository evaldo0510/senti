  ...
  return (
    <AnimatePresence>
      <motion.button
        ...
        className="fixed bottom-44 right-6 z-[100] flex h-20 w-20 flex-col items-center justify-center gap-1 overflow-hidden rounded-full bg-[#dc2626] text-white shadow-[0_20px_40px_rgba(220,38,38,0.3)] transition-all hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
